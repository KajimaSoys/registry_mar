# Generated by Django 4.0.3 on 2022-03-16 00:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('registry', '0002_remove_medcards_exemptid_remove_shedule_roomid_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mcid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registry.medcards', verbose_name='Карточка пациента')),
                ('scheduleid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registry.schedule', verbose_name='Расписание')),
        ...
        migrations.AddField(
            model_name='doctors',
            name='schedule',
            field=models.ManyToManyField(to='registry.schedule', verbose_name='Открытые даты для посещения'),
        ),
        migrations.AddField(
            model_name='doctors',
            name='typeid',
